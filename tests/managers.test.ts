...
import type { ManagerSystem as ManagerSystemType } from '../src/managers.js';
...
const { ManagerSystem } = await import('../src/managers.js') as { ManagerSystem: typeof ManagerSystemType };
